  ...
  module PaginateV2::Generator
    ...
    class PaginationModel
      ...
      def paginate(template, config, site_title, all_posts, all_tags, all_categories, all_locales)
        ...
        using_posts = PaginationIndexer.read_config_value_and_query_posts(config, 'query', using_posts)
        self._debug_print_filtering_info('Query', before, using_posts.size)
        before = using_posts.size
